...
//BEGIN_STAGE_THREE
	virtual void emit_photons(Photon *photons, int max_photons)
	{
		
	}

	virtual void emit_caustic_photons(Photon *photons, int max_photons)
	{
		
	}


	virtual void get_position(Vertex &position)
	{
